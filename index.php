...
if(file_exists("world.txt"))
    echo "<h1>7. Файл ворлд.тхт существует</h1>";
else echo "<h1>7. Файл ворлд.тхт не существует</h1>";
if(file_exists("mir.txt"))
    echo "<h1>7. Файл мир.тхт существует</h1>";
else echo "<h1>7. Файл мир.тхт не существует</h1>";